...
INSERT INTO regla_diagnostico (id_categoria, nombre_regla, condicion, nivel_confianza, prioridad) VALUES
 (1, 'Ruido metalico al frenar',
     '{"palabras":["chilla","rechina","ruido al frenar","metalico","pastilla","disco de freno","balata"],"km_minimo":0}', 0.900, 1),
 (1, 'Pedal esponjoso o hundido',
     '{"palabras":["pedal","esponjoso","se hunde","sin presion","no frena","liquido de freno"],"km_minimo":0}', 0.880, 1),
 (2, 'Golpeteo en superficie irregular',
     '{"palabras":["golpetea","brinca","tumbo","suspension","amortiguador","resorte","salta en los baches"],"km_minimo":0}', 0.850, 2),
 (3, 'Vehiculo desviado de trayectoria',
     '{"palabras":["jala","se va","desvia","direccion dura","timon","volante","alineacion","rotula","terminal"],"km_minimo":0}', 0.870, 2),
 (4, 'Perdida de potencia del motor',
     '{"palabras":["no jala","sin fuerza","pierde potencia","cascabeleo","tironea","jalonea","se apaga","falla el motor","aceite"],"km_minimo":0}', 0.840, 1),
 (5, 'Arranque deficiente',
     '{"palabras":["no enciende","no arranca","cuesta arrancar","falla al arrancar","marcha","bujia","no da chispa"],"km_minimo":0}', 0.860, 1),
 (6, 'Falla de carga electrica',
     '{"palabras":["bateria","se descarga","luz de bateria","no da corriente","alternador","fusible","sistema electrico","las luces"],"km_minimo":0}', 0.890, 1),
 (7, 'Falla de la transmision',
     '{"palabras":["embrague","patina","no entra cambio","clutch","caja mecanica","caja de cambios","caja de velocidades","transmision","velocidades","sincronizado","palanca de cambios"],"km_minimo":0}', 0.850, 2),
 (8, 'Sobrecalentamiento del motor',
     '{"palabras":["calienta","calentamiento","sobrecalent","temperatura","hierve","vapor","radiador","refrigerante","ventilador"],"km_minimo":0}', 0.910, 1),
 (9, 'Consumo excesivo de combustible',
     '{"palabras":["gasta mucho","consumo","gasolina","rinde poco","inyector","combustible","bomba de gasolina"],"km_minimo":0}', 0.800, 3),
 (10, 'Ruido o fuga en el escape',
     '{"palabras":["escape","ruidoso","truena","humo negro","mofle","silenciador","catalizador"],"km_minimo":0}', 0.820, 3),
 (11, 'Desgaste irregular de neumaticos',
     '{"palabras":["llanta","neumatico","desgaste","vibra","desbalance","balanceo","rin","presion de aire"],"km_minimo":0}', 0.830, 2),
 (12, 'Aire acondicionado sin enfriamiento',
     '{"palabras":["aire acondicionado","no enfria","clima","compresor","gas del aire"],"km_minimo":0}', 0.870, 3);
